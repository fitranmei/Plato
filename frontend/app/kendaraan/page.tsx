          ...
          {data.map((item) => {
            return (
              ...
              >
                ...
                <div className="bg-gray-100 px-3 py-1 rounded-full text-sm text-left">
                  {item.jenis}
                </div>
  ...
  return (
    <main className="min-h-screen bg-[#24345A] text-white font-sans">
      <div className="p-8 max-w-5xl mx-auto">
        ...
        {renderTable(KLASIFIKASI_LUAR_KOTA, "Klasifikasi Kendaraan Pada Jalan Luar Kota")}
        {renderTable(KLASIFIKASI_BEBAS_HAMBATAN, "Klasifikasi Kendaraan Pada Jalan Bebas Hambatan")}
